...
BEGIN 
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'resources' AND column_name = 'slack_user_id') THEN 
        ALTER TABLE resources ADD COLUMN slack_user_id TEXT; 
    END IF;
END $$;
